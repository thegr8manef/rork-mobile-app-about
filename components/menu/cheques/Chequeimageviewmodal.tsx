...
interface ChequeImageViewModalProps {
  visible: boolean;
  chequeNumber?: string;
...
export default function ChequeImageViewModal({
  visible,
  chequeNumber,
  imageBase64,
  onClose }: ChequeImageViewModalProps) {
      ...
      <View style={styles.modalOverlay}>
        ...
        <View style={[styles.header, { paddingTop: insets.top + Spacing.md }]}>
          ...
          <View style={styles.headerCenter}>
            <TText style={styles.headerTitle} tKey="cheques.viewCheque" />
            {chequeNumber && (
              <TText style={styles.headerSubtitle}>{chequeNumber}</TText>
            )}
          </View>
        ...
        <View style={styles.imageContainer}>
          {imageBase64 ? (
            ...
            <View style={styles.errorContainer}>
              <TText style={styles.errorText} tKey="cheques.imageLoadError" />
            </View>
          )}
        </View>
      </View>
